...
(function ($) {
	...
	var wpt_MobileMenu = function () {
		...
		// 	var mainMenuMobi = $('#main-menu-mobi').css("display");
		...
		// 		e.stopPropagation();
		// 	} else if (mainMenuMobi == "block" && wpt_is_small_screen()) {
		// 		$('#menu-responsive').hide();
		// 		$('#main-menu-mobi').css({ "display": "none" })
		// 	}
		// });
		...
		if (wpt_is_small_screen() && $('#menu-responsive a').length) {
